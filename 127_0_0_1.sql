...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2021 at 03:01 PM
...
INSERT INTO `connection` (`fname`, `lname`, `email`, `address`, `message`) VALUES
('lovely', 'gupta', 'lovely@gmail.com', 'hans enclave', 'connect'),
('om', 'prakash', 'og@gmail.com', 'naharpur', 'want to connect');
--
-- Database: `learn`
--
CREATE DATABASE IF NOT EXISTS `learn` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `learn`;
...
CREATE TABLE `member` (
  `membership_number` varchar(5) COLLATE utf8mb4_bin DEFAULT NULL,
  `full_name` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `gender` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
  `physical_address` varchar(100) COLLATE utf8mb4_bin DEFAULT NULL,
  `postal_address` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `contact_number` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL,
...
INSERT INTO `member` (`membership_number`, `full_name`, `gender`, `physical_address`, `postal_address`, `contact_number`, `email`) VALUES
('1', 'Prat', 'male', 'gopal', 'gopal', '12345678', '[sss@gmail.com]'),
('1', 'jassi', 'male', 'punjab', 'gurgganj', '1434678', '[sss@gmail.com]'),
('1', 'gecko', 'male', 'gurgaon', 'gopalganj', '1234523418', '[sss@gmail.com]');
...
INSERT INTO `users` (`uid`, `fname`, `lname`, `email`, `phone`, `gender`, `pass`) VALUES
(1, 'gaurav', 'gupta', 'smartguptagaurav01@gmail.com', 9953551807, 'MALE', '$2y$10$Go/nJRZHWLsjWrQjmtxpZ.8kWC4h4qFYZVVDg0QPrMlwkDvGMFGmi'),
(2, 'lovely', 'gupta', 'lovely@gmail.com', 8663889282, 'FEMLALE', '$2y$10$olmVgENFUkunoDHb54nnK.pxgLv4OE1m1GE3DmgcFxpfHUp7QfTWS'),
(3, 'sasas', 'asas', 'sukant012gmail.com', 9875568879, 'TRANSGENDER', '$2y$10$c/AL/n0XIzdEWNCOKI7ywuih4BBleDlpm7aT6YE3zSyEKIeqFF/EW'),
(4, 'gecko', 'gupta', 'geckowsan01@gmail.com', 9089674534, 'MALE', '$2y$10$mQ.s3P56aUGtMLm7Zla6cuz.yagrtkhIayCLr0a7QVzaXKodBuUMy');
...
-- Database: `learn1`
--
CREATE DATABASE IF NOT EXISTS `learn1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
USE `learn1`;
...
CREATE TABLE `users1` (
  ...
  `pass` varchar(250) COLLATE utf8mb4_bin NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `users1` (`uid`, `fname`, `lname`, `email`, `phone`, `gender`, `pass`) VALUES
(1, 'gaurav', 'gupta', 'geckowsan01@gmail.com', 9953551807, 'MALE', 'hello123'),
(2, 'lovely', 'gupta', 'geckowsan01@gmail.com', 9953551807, 'FEMLALE', 'hello123');
...
INSERT INTO `item` (`fname`, `phone`, `email`, `address`, `orderitem`) VALUES
('gaurav', 9989092899, 'guptagaurav01@gmail.com', 'rajeev colony', 'chicken burger');
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"quiz\",\"table\":\"addquestion\"},{\"db\":\"quiz\",\"table\":\"addtest\"},{\"db\":\"quiz\",\"table\":\"addclass\"},{\"db\":\"quiz\",\"table\":\"addstudent\"},{\"db\":\"quiz\",\"table\":\"quizdata\"},{\"db\":\"quiz\",\"table\":\"addteacher\"}]');
...
('root', '2021-12-27 14:01:43', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":277}');
